...
from app.api.routes import (
    ...
    delivery, pagos, ejecutivo, backup,
)
...
router.include_router(delivery.router, prefix="/delivery", tags=["Delivery Tracking"])
router.include_router(pagos.router, prefix="/pagos", tags=["Pagos Online"])
